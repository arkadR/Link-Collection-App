...
{
    public partial class LinkCollectionAppContext : DbContext
    {
        public LinkCollectionAppContext()
        {
        }

        public LinkCollectionAppContext(DbContextOptions<LinkCollectionAppContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=LinkCollectionApp");
            }
        }
